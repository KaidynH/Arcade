...
class Goei(Enemy):
    def __init__(self, pEntry, pPos, pFormation):
        ...
        super().__init__('Galaga\Images\Goei.png', 30, 5, x, y, 90)

        # Goei position indexes related to the formation parameter
        ...
        # Goei formation positions
        self.formations = np.array([[[57 + (i * 45), 200] for i in range (1, 13)], [[57 + (i * 45), 150] for i in range (1, 13)]])

        # Goei position in formation
        ...
        # Directions the Goei will face along its path
        self.angles = []
